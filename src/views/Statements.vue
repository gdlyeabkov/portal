        ...
        <div style="background-color: rgb(245, 245, 245);">
            <div style="position: relative; top: 75px; width: 85%; margin: auto; height: 590px;">
                <div style="display: flex; justify-content: space-between; width: 650px; ">
                    ...
                    <p :style="`color: ${false ? 'rgb(0, 0, 255);' : 'rgb(0, 0, 0);'} text-decoration: ${false ? 'underline;' : 'none;'} font-size: 18px; font-weight: bolder; line-height: 15px; cursor: pointer;`" @click="$router.push({ name: 'Statements' })">
                        Заявления
                    </p>
